...
# Temps de génération: 2017-02-24 17:29:14 +0000
# ************************************************************
...
# Affichage de la table interests
# ------------------------------------------------------------
...
INSERT INTO `interests` (`id`, `interest_name`, `created_at`, `updated_at`)
VALUES
...
INSERT INTO `notification` (`id`, `id_author`, `id_receiver`, `created_at`, `seen`, `action_type`)
VALUES
...
INSERT INTO `photos` (`id`, `photo_link`, `id_user`, `created_at`, `isProfil`)
VALUES
...
INSERT INTO `seen` (`id`, `id_author`, `id_receiver`, `created_at`)
VALUES
...
INSERT INTO `users` (`id`, `email`, `last_name`, `first_name`, `login`, `password`, `gender`, `orientation`, `birth_date`, `bio`, `lat`, `lng`, `city`, `zip`, `country`, `popularity`)
VALUES
	(1,'Googole@gmail.com','Zane','Anis','Titi','$2a$10$sgWlckIeEsn/G8yKeJ/lF.iULBfEfq6qViFVDi61sRKD2IW1v5lxq','m','Hetero','23/02/1994','ojdowdwqopjdwqopqwjdqwopdqwjdqw',48.892,2.31929,'Paris',75017,'France',0),
	(3,'thelene@gmail.com','tamere','Helene','thelene','$2a$10$j6zhV5zc1S13Q1d1eX/bVOAObYY8IyaBcuv.u1vW2iHv3xI/AYhUK','f','Hetero','21/05/1996','Test est la vie',48.892,2.31929,'Paris',75017,'France',0),
	(4,'tamandine@gmail.com','therese','amandine','tamandine','$2a$10$.OD.AzrNwtaQ/N.7s3I/6e94LleXdL9Tqd07MYqPDrcBAcafwLb5m','f','Homo','28/12/1995','la vie est chiante',48.892,2.31929,'Paris',75017,'France',0),
	(5,'tsarah@gmail.com','trista','sarah','tsarah','$2a$10$OBTcYk4WXgU6/Pxs9FgHkeQwwwEiA1F5WPWj6AW5AAMKf1CmF85He','f','Hetero','21/02/1995','j\'aime manger',48.8792,2.33459,'Paris',75009,'France',0),
	(6,'bkobe@gmail.com','bryant','kobe','bkobe','$2a$10$3SyGtp/j6U8krupMyFqcueN/4nho4EKTSmjw3Q.zS4RdlVRV9j3pa','m','Homo','21/02/1980','basketball forever',48.8967,2.31843,'Paris',75017,'France',0),
	(7,'pbrad@gmail.com','pitt','brad','pbrad','$2a$10$ZuLeZj2Cax39/yPoeguTdOXUW7DRXCwT9eRHd533Oedc5UJc25Pae','m','Hetero','21/02/1992','Angelina m\'a quitté :(',48.8968,2.31846,'Paris',75017,'France',0),
	(8,'cbenjamin@gmail.com','castaldi','benjamin','cbenjamin','$2a$10$rliK954tjOi.MzddHAPqxuX1NMmS21l0FrBBCjNoSpqDU9NF0Z0Im','m','Hetero','21/02/1988','Tentez de remporter le jackpot tous les jours a 21h45 sur bravolot',48.8967,2.31841,'Paris',75017,'France',0),
	(9,'tdonald','trump','donald','tdonald','$2a$10$tO0ebRu7jGAw4kNhhY.STOIcxfopZLiaUS3nWHONGHbjkygdjY/vq','m','Homo','21/02/1945','make America great again',43.6122,4.88068,'Saint-Martin-de-Crau',13310,'France',0),
	(10,'zzineddine@gmail.com','zidane','zineddine','zizou','$2a$10$RWz/jZ1gMVXxs7vYatr.B.UvRYOB1/MzCZn9GwLz36ghTaaBlBKZm','m','Hetero','21/03/1994','Football is Football',48.8967,2.31843,'Paris',75017,'France',0),
	(11,'mzane@student.42.fr','jolie','angelina','jangelina','$2a$10$Fmiwxu9PRdxaTDCmZNEiWOBg77.0FLDURc56LK49evVgWTd.Bi4qC','f','Hetero','14/12/1995','I\'m free',48.892,2.31929,'Clichy',92110,'France',0),
	(12,'tsarah@gmail.com','swift','taylor','tswift','$2a$10$4SOA8OCFVYhU28LdJNV93umKXFlmdMrvXY87VQFLMQuWif4ZOIRIO','f','Hetero','30/12/1990',NULL,48.892,2.31929,'Paris',75017,'France',0),
	(13,'hello','hello','hello','hello','$2a$10$IMuzBDaE8cNPnMsVKBWECe6uBZkb40j28MElA/yj4aQ6YTYqBaK.m',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0);

/*!40000 ALTER TABLE `users` ENABLE KEYS */;
UNLOCK TABLES;


# Affichage de la table usersinterests
# ------------------------------------------------------------
...
INSERT INTO `usersinterests` (`id_user`, `id_interest`)
VALUES
	(1,3),
	(1,4),
	(1,5),
